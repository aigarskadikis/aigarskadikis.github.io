...
<style>
* { margin:0; padding:0; }
#output { margin:0 0 20px; min-height: 30vh; background-color: whitesmoke; float:left;width:50%; }
#config { padding: 10px; border: 1px solid silver; float:right;width:40%}
