...
SELECT `groupid` FROM `group_discovery` WHERE `groupid` NOT IN (SELECT `groupid` FROM `groups`);
...
SELECT `groupid` FROM `hosts_groups` WHERE `groupid` NOT IN (SELECT `groupid` FROM `groups`);
...
SELECT `groupid` FROM `maintenances_groups` WHERE `groupid` NOT IN (SELECT `groupid` FROM `groups`);
...
SELECT `id` FROM `rights` WHERE `id` NOT IN (SELECT `groupid` FROM `groups`);
...
SELECT `value_groupid` FROM `widget_field` WHERE `value_groupid` NOT IN (SELECT `groupid` FROM `groups`);
