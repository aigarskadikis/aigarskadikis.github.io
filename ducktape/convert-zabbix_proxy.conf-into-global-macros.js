...
// sed 's|SID|9cfdda12eb693d0640d0f51b3afd66d9|g;s|JSON_RPC|http://127.0.0.1/api_jsonrpc.php|g' convert-zabbix_proxy.conf-into-global-macros.js > ~/convert-zabbix_proxy.conf-into-global-macros.js

// usage:
// zabbix_js --script convert-zabbix_proxy.conf-into-global-macros.js --timeout 60 --input <(grep -v "^$\|#" /etc/zabbix/zabbix_proxy.conf) --loglevel 3
