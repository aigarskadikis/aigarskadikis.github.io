...
SELECT `eventid` FROM `event_symptom` WHERE `eventid` NOT IN (SELECT `eventid` FROM `events`);
...
SELECT `userid` FROM `user_scim_group` WHERE `userid` NOT IN (SELECT `userid` FROM `users`);
SELECT `scim_groupid` FROM `user_scim_group` WHERE `scim_groupid` NOT IN (SELECT `scim_groupid` FROM `scim_group`);
SELECT `userdirectoryid` FROM `userdirectory_idpgroup` WHERE `userdirectoryid` NOT IN (SELECT `userdirectoryid` FROM `userdirectory`);
SELECT `roleid` FROM `userdirectory_idpgroup` WHERE `roleid` NOT IN (SELECT `roleid` FROM `role`);
SELECT `userdirectoryid` FROM `userdirectory_ldap` WHERE `userdirectoryid` NOT IN (SELECT `userdirectoryid` FROM `userdirectory`);
SELECT `userdirectoryid` FROM `userdirectory_media` WHERE `userdirectoryid` NOT IN (SELECT `userdirectoryid` FROM `userdirectory`);
SELECT `mediatypeid` FROM `userdirectory_media` WHERE `mediatypeid` NOT IN (SELECT `mediatypeid` FROM `media_type`);
SELECT `userdirectoryid` FROM `userdirectory_saml` WHERE `userdirectoryid` NOT IN (SELECT `userdirectoryid` FROM `userdirectory`);
SELECT `userdirectory_idpgroupid` FROM `userdirectory_usrgrp` WHERE `userdirectory_idpgroupid` NOT IN (SELECT `userdirectory_idpgroupid` FROM `userdirectory_idpgroup`);
SELECT `usrgrpid` FROM `userdirectory_usrgrp` WHERE `usrgrpid` NOT IN (SELECT `usrgrpid` FROM `usrgrp`);
...
SELECT `value_actionid` FROM `widget_field` WHERE `value_actionid` NOT IN (SELECT `actionid` FROM `actions`);
SELECT `value_mediatypeid` FROM `widget_field` WHERE `value_mediatypeid` NOT IN (SELECT `mediatypeid` FROM `media_type`);
...
SELECT `value_userid` FROM `widget_field` WHERE `value_userid` NOT IN (SELECT `userid` FROM `users`);
